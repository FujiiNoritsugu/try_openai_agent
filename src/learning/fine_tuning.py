...
class FineTuningManager:
    ...
    def prepare_training_data(self, feedback_history: List[UserFeedback], output_path: str) -> str:
        """
    ...
    def wait_for_fine_tuning(self, job_id: str, timeout_seconds: int = 3600) -> Optional[str]:
        """
