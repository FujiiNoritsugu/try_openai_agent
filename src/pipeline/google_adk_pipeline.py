"""
Google ADKを使用したエージェントパイプラインの実行ロジック。
"""
...
from .google_adk_emotion_processor import EmotionProcessor
from .google_adk_emotion_classifier import EmotionClassifier
from .error_handler import handle_pipeline_error, log_error


class EmotionPipeline:
    """Google ADKを使用した感情分析パイプライン"""
